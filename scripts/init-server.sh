...
log "Setting up SSL certificate for your-domain.example.com..."
SSL_EMAIL=${SSL_EMAIL:-"admin@utia.cas.cz"}
certbot certonly --standalone -d your-domain.example.com --non-interactive --agree-tos --email "$SSL_EMAIL"

# Create SSL directory for nginx
mkdir -p /opt/bsmarker/nginx/ssl
ln -sf /etc/letsencrypt/live/your-domain.example.com /opt/bsmarker/nginx/ssl/
...
log "- SSL certificates: /etc/letsencrypt/live/your-domain.example.com"