...
const KeyboardShortcutsModal: React.FC<KeyboardShortcutsModalProps> = ({
  ...
  const shortcuts = [
    ...
    { key: "Backspace / Delete", description: "Delete selected bounding box", section: "Editing" },
    ...
    { key: "Alt / Option + Hover", description: "Measure distance between boxes", section: "View" },
